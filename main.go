...
import (
	...
	"github.com/incerto13/go-graphql-api/gql"
	"github.com/incerto13/go-graphql-api/postgres"
	"github.com/incerto13/go-graphql-api/server"
...
func initializeAPI() (*chi.Mux, *postgres.Db) {
	...
	db, err := postgres.New(
		postgres.ConnString("localhost", 5432, "hezekiah", "go_graphql_db"),
	)
	if err != nil {
		log.Fatal(err)
	}
